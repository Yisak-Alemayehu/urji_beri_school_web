...
$postUrl = SITE_URL . '/blog-detail.php?slug=' . $post['slug'];
        ...
        <div class="container">
            <div class="page-header-content">
                ...
                <nav class="breadcrumb">
                    ...
                    <a href="<?php echo SITE_URL; ?>/blog.php">News</a>
                    <span class="breadcrumb-separator">/</span>
            ...
            <article class="glass-card-solid">
                ...
                <div class="text-center mt-8 pt-8" style="border-top: 1px solid var(--gray-200);">
                    ...
                    <div class="btn-group justify-center">
                        ...
                        <a href="https://wa.me/?text=<?php echo urlencode($post['title'] . ' - ' . SITE_URL . '/blog-detail.php?slug=' . $post['slug']); ?>" 
                           target="_blank" class="btn btn-outline btn-sm">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <article class="glass-card blog-card">
                                ...
                                <div class="blog-card-content">
                                    ...
                                    <h3 class="blog-card-title">
                                        <a href="<?php echo SITE_URL; ?>/blog-detail.php?slug=<?php echo e($relatedPost['slug']); ?>"><?php echo e($relatedPost['title']); ?></a>
                                    </h3>
                                    <a href="<?php echo SITE_URL; ?>/blog-detail.php?slug=<?php echo e($relatedPost['slug']); ?>" class="blog-card-link">
                                        Read More
