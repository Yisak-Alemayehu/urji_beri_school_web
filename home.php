...
?>
    ...
    <!-- Hero Section -->
    <section class="hero pro-hero" aria-label="Welcome to <?php echo e(get_setting('site_name', 'Urji Beri School')); ?>">
            ...
            <div class="hero-layout">
                <div class="hero-content">
                    <div class="hero-brand-lockup">
                        <img src="<?php echo e(branding_url('site_logo')); ?>" alt="" class="hero-logo-mark" width="64" height="64" decoding="async">
                        <h1 class="hero-brand"><?php echo e(get_setting('site_name', 'Urji Beri School')); ?></h1>
                    </div>
                    <p class="hero-title"><?php echo e(get_setting('hero_subtitle', get_setting('site_tagline', 'Nurturing young minds for a brighter future'))); ?></p>
                    <p class="hero-subtitle"><?php echo e(get_setting('hero_description', 'Quality preschool and elementary education for children ages 3 to 13 in Alemgena.')); ?></p>
                    <div class="hero-buttons">
                        ...
                        <a href="<?php echo route_url('contact'); ?>" class="btn btn-outline btn-lg">
                            <?php echo e(get_setting('cta_secondary_text', 'Contact Admissions')); ?>
                        </a>
                    </div>
                </div>
